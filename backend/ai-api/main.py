...
async def generate_url(
    ...
    if lang == "th":
        modprompt = (
            ...
            f"ให้ผลลัพธ์เป็น true หรือ false (ถ้าปลอม คือ false ถ้าจริง คือ true) ตามด้วยเครื่องหมายจุลภาคและเปอร์เซ็นต์ความแม่นยำ "
...
async def generate_url(
    ...
    if lang == "th":
        modprompt = (
            ...
            f"ให้ผลลัพธ์เป็น true หรือ false (ถ้าสร้างด้วย AI คือ false ถ้าไม่ คือ true) ตามด้วยเครื่องหมายจุลภาคและเปอร์เซ็นต์ความแม่นยำ "
